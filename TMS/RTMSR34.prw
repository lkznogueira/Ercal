...
If ( lMDFEAUT .And. IsInCallStack("TmsMDFeAut") .And. Len(PARAMIXB[1]) == 8 ) .Or. ( IsInCallStack("TMSAC30Man") .And. Len(PARAMIXB[1]) == 10 )
...
oDamdfe:= FWMSPrinter():New(cFilePrint, IMP_PDF, .F., cStartPath, lImp, , @oDamdfe, , , , , !lImp )
