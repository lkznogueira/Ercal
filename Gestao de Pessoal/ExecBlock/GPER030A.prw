...
nDuas      := If(mv_par21 == "N",1,2)							    //quantas vezes é para imprimir o mesmo contra-Cheque
...
// Verifica se for a primeir impressão envia o comando de compactar a impressora
...
ElseIf Esc == 2 // Folha Mensal
	@ LI,090 PSAY "Mensal"
ElseIf Esc == 3 // 1¦ Parcela do 13o Salário
	@ LI,090 PSAY "1a. Parcela 13o Salario"
ElseIf Esc == 4 // 13o. Salário 2o.Parc.
...
@ ++Li,00 PSAY "Admissão: " + DTOC(SRA->RA_ADMISSA)
@ Li,30  PSAY "Função: " + Substr(cDescFunc ,1,15)
cCargo := fGetCargo(SRA->RA_MAT)
...
//Linha 2
_oPrint:Say(_cont+0345, 0115, "Função:"                    , _oFont8)//Titulo Funcao
...
_oPrint:Say(_cont+0345, 1400, "Data Admissão:"          , _oFont8)//Titulo Data Admissao
...
_oPrint:Say(_cont+1295, 0150, "Salário-Base"   , _oFont8b)
_oPrint:Say(_cont+1295, 0500, "Sal. Contr. INSS" , _oFont8b)
_oPrint:Say(_cont+1295, 1000, "Base Cálc. FGTS"  , _oFont8b)
_oPrint:Say(_cont+1295, 1310, "F.G.T.S. do Mês"  , _oFont8b)
_oPrint:Say(_cont+1295, 1590, "Base Cálc. IRRF"  , _oFont8b)
