	...
	#define STR0019 "VALOR INTER"
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Banco  Código     Cliente                      Nr.título           Vencto      Atraso  Pgt                Valor     Valor Juros----->Filial", "BANCO  CODIGO     CLIENTE                      No.TITULO           VENCTO      ATRASO  PAGTO       VALOR     VALOR JUROS----->FILIAL" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Banco  Código                     Cliente                      Nr.título           Vencto      Atraso  Pgt                Valor     Valor Juros----->Filial", "BANCO  CODIGO                     CLIENTE                      No.TITULO           VENCTO      ATRASO  PAGTO               VALOR     VALOR JUROS----->FILIAL" )
