	...
	#define STR0027 "     Cliente   Pedido   Emision   Ctd. Pedido       Fac./ Serie  Emision          Ctd Factura         Total NF      Desconto"
	...
	#define STR0029 "Finalizado Manualm."
		...
		#define STR0027 "     Customer  Order    Issue Dt  Order qty.        Inv./Series  Issue Dt         Invoice quant.         Total NF      Desconto"
		...
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "     Cliente   Pedido   Emissão   Qtd.pedido  EST?  Fact./série   Emissão          Qtd. Factura         Total NF      Desconto", "     Cliente   Pedido   Emissao   Qtd.Pedido  EST?  Nota/Serie   Emissao          Qtd Nota Fiscal         Total NF      Desconto" )
		...
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Encerrado Manualmente", "Encerrado Manualmente" )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Contrato em Aberto", "Contrato em Aberto" )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "Contrato Entregue", "Contrato Entregue" )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Contrato Aprovado", "Contrato Aprovado" )
