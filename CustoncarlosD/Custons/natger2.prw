...
±±ºPrograma  ³natger   º Autor ³ Carlos Daniel º Data ³  07/05/19         º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Relatorio Natureza Gerencial.                              º±±
±±º          ³                                                            º±±
...
Private limite     := 120
Private tamanho    := "G"
Private nomeprog   := "natger2" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo      := 18
Private aReturn    := { "Zebrado", 1, "Administracao", 2, 2, 1, "", 1}
Private nLastKey   := 0
Private cPerg      := "natger2"
Private cbtxt      := Space(10)
Private cbcont     := 00
Private CONTFL     := 01                                                                  
Private m_pag      := 01
Private wnrel      := "natger2" // Coloque aqui o nome do arquivo usado para impressao em disco      
Private cString := "Z11"
